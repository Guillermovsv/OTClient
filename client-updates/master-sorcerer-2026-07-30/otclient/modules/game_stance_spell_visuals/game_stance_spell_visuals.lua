...
-- These spells use complete server-selected sprite variants. Do not apply the
-- legacy flat client tint on top of those assets.
local spriteVariantSpells = { [23] = true, [24] = true, [119] = true, [240] = true }
...
local function onExtendedOpcode(protocol, opcode, buffer)
    ...
    if spriteVariantSpells[spellId] then
        g_client.clearMasterSorcererSpellVisual()
        return
    end
