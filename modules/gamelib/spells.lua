...
SpellInfo = {
    Default = {
        ...
        ['Master of Flames'] = { id = 301, name = 'Master of Flames', words = 'utamo flam', type = 'Instant', level = 60, mana = 0, soul = 0, maglevel = 0, icon = '', clientId = 109, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0 },
        ['Master of Thunder'] = { id = 302, name = 'Master of Thunder', words = 'utamo vis', type = 'Instant', level = 60, mana = 0, soul = 0, maglevel = 0, icon = '', clientId = 110, group = {}, needTarget = false, parameter = false, range = -1, exhaustion = 0, premium = true, vocations = {1, 5}, special = false, source = 0 },
        ['Master of Decay'] = { id = 303, name = 'Master of Decay', words = 'utamo mort', type = 'Instant', level = 60, mana = 0, soul = 0, maglevel = 0, icon = '', clientId = 53, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0 },
