...
SpellInfo = {
    Default = {
        ...
        ['Protector'] = {id = 132, name = 'Protector', words = 'utamo tempo', type = 'Instant', level = 20, mana = 20, soul = 0, maglevel = 0, icon = '', clientId = 121, group = {[3] = 2000}, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {4, 8}, special = false, source = 0, description = 'Shielding +30%; damage dealt and damage received -15%.'},
        ['Blood Rage'] = {id = 133, name = 'Blood Rage', words = 'utito tempo', type = 'Instant', level = 20, mana = 20, soul = 0, maglevel = 0, icon = '', clientId = 95, group = {[3] = 2000}, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {4, 8}, special = false, source = 0, description = 'Melee skills +30%; damage received +15%.'},
        ...
        ['Sharpshooter'] = {id = 135, name = 'Sharpshooter', words = 'utori con', type = 'Instant', level = 20, mana = 250, soul = 0, maglevel = 0, icon = '', clientId = 120, group = {[3] = 2000}, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = false, vocations = {3, 7}, special = false, source = 0, description = 'Grants 32% Distance Fighting. The skill bonus impacts your total skill (including bonuses from gear and other buffs like potions).' },
        -- 136->137?
        ...
        ['Elemental Synthesis'] = { id = 299, name = 'Elemental Synthesis', words = 'utito dru', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 189, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {2, 6}, special = false, source = 0, description = 'Grants 10% of your Magic Level as additional ice and earth magic level.' },
        ['Shared Conservation'] = { id = 300, name = 'Shared Conservation', words = 'utura sio', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 190, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {2, 6}, special = false, source = 0, description = 'Grants +10% self-healing. Additionally, Heal Friend and Nature\'s Embrace heal a secondary target for 30% of their healing, where the secondary target is the lowest health in the gamewindow and party and cannot be the original target.' },
        ['Master of Flames'] = { id = 301, name = 'Master of Flames', words = 'uteta flam', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 191, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0, description = 'Fire spell damage +4%; the next non-Fire spell can be converted to Fire.' },
        ['Master of Thunder'] = { id = 302, name = 'Master of Thunder', words = 'uteta vis', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 192, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0, description = 'Energy critical chance +4%; the next non-Energy spell can be converted to Energy.' },
        ['Master of Decay'] = { id = 303, name = 'Master of Decay', words = 'uteta mort', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 193, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0, description = 'Death critical extra damage +30%; the next non-Death spell can be converted to Death.' },
        ['Divine Defiance'] = { id = 304, name = 'Divine Defiance', words = 'utori hur', type = 'Instant', level = 20, mana = 250, soul = 0, maglevel = 0, icon = '', clientId = 194, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {3, 7}, special = false, source = 0, description = 'Grants 6% of Distance Fighting as holy and healing magic level, as well as 12% Dodge against non adjacent enemies.' },
        ['Aura of Exposed Weakness'] = { id = 243, name = 'Aura of Exposed Weakness', words = 'exori moe tempo', type = 'Instant', level = 175, mana = 1500, soul = 0, maglevel = 0, icon = '', clientId = 195, group = { [3] = 2000, [6] = 30000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0, description = 'Your spells, runes and auto attacks apply Expose Weakness to their targets, granting 8% Elemental Pierce to attackers.' },
        ['Aura of Sapped Strength'] = { id = 244, name = 'Aura of Sapped Strength', words = 'exori kor tempo', type = 'Instant', level = 175, mana = 1500, soul = 0, maglevel = 0, icon = '', clientId = 196, group = { [3] = 2000, [6] = 30000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0, description = 'Your spells, runes and auto attacks apply Sap Strength to their targets, reducing the damage they deal by 10%.' },
        ['Forked Thorns'] = { id = 298, name = 'Forked Thorns', words = 'exevo fur tera', type = 'Instant', level = 80, mana = 180, soul = 0, maglevel = 0, icon = '', clientId = 187, group = { [1] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 6000, premium = true, vocations = {2, 6}, special = false, source = 0, description = 'Chain earth damage to up to 7 targets.' },
        ['Forked Glacier'] = { id = 305, name = 'Forked Glacier', words = 'exevo fur frigo', type = 'Instant', level = 90, mana = 180, soul = 0, maglevel = 0, icon = '', clientId = 188, group = { [1] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 6000, premium = true, vocations = {2, 6}, special = false, source = 0, description = 'Chain ice damage to up to 7 targets.' },
    }
}
...
-- Base spell damage: the formula evaluated at the spell's own level and magic
-- level requirements, not against the logged in character. It is therefore a
-- fixed property of the spell, the same for everyone.
--
-- It still comes from the server rather than the static table above, because the
-- formulas live in the datapack's spell scripts and Canary does not expose them
-- to the client. See modules/game_cyclopedia/serverSIDE/ for the server half.
SPELL_DAMAGE_OPCODE = 220

local spellDamage = {}

-- expects a list of {id = spellId, min = number, max = number, kind = 'damage'|'healing'}
function Spells.setDamageInfo(spells)
    spellDamage = {}
    ...
    for _, entry in ipairs(spells) do
        ...
        if id and min and max then
            -- the server reports damage as negative values
            ...
            spellDamage[id] = {
                min = math.floor(min),
                max = math.floor(max),
                kind = entry.kind == 'healing' and 'healing' or 'damage'
            }
        end
    end
end

function Spells.getDamageInfo(spellId)
    if spellId == nil then
        return nil
    end
    return spellDamage[spellId]
end

function Spells.clearDamageInfo()
    spellDamage = {}
end

function Spells.hasDamageInfo()
    return next(spellDamage) ~= nil
end

function Spells.requestDamageInfo()
    local protocolGame = g_game.getProtocolGame()
    if not protocolGame then
        return false
    end

    protocolGame:sendExtendedJSONOpcode(SPELL_DAMAGE_OPCODE, {action = 'spellDamage'})
    return true
end
