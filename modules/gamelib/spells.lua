...
SpellInfo = {
    Default = {
        ...
        ['Master of Flames'] = { id = 301, name = 'Master of Flames', words = 'uteta flam', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 109, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0 },
        ['Master of Thunder'] = { id = 302, name = 'Master of Thunder', words = 'uteta vis', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 110, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 0, premium = true, vocations = {1, 5}, special = false, source = 0 },
        ['Master of Decay'] = { id = 303, name = 'Master of Decay', words = 'uteta mort', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 53, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0 },
        ...
        ['Forked Thorns'] = { id = 1901, name = 'Forked Thorns', words = 'exevo fur tera', type = 'Instant', level = 80, mana = 180, soul = 0, maglevel = 0, icon = '', clientId = 187, group = { [1] = 2000 }, needTarget = true, parameter = false, range = 3, exhaustion = 6000, premium = true, vocations = {2, 6}, special = false, source = 0 },
        ['Forked Glacier'] = { id = 1900, name = 'Forked Glacier', words = 'exevo fur frigo', type = 'Instant', level = 90, mana = 180, soul = 0, maglevel = 0, icon = '', clientId = 188, group = { [1] = 2000 }, needTarget = true, parameter = false, range = 3, exhaustion = 6000, premium = true, vocations = {2, 6}, special = false, source = 0 },
    }
}
