...
SpellInfo = {
    Default = {
        ...
        ['Aura of Exposed Weakness'] = {id = 243, name = 'Aura of Exposed Weakness', words = 'exori moe tempo', type = 'Instant', level = 175, mana = 1500, soul = 0, maglevel = 0, icon = '', clientId = 109, group = {[3] = 2000, [6] = 30000}, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0},
        ['Aura of Sapped Strength'] = {id = 244, name = 'Aura of Sapped Strength', words = 'exori kor tempo', type = 'Instant', level = 175, mana = 1500, soul = 0, maglevel = 0, icon = '', clientId = 110, group = {[3] = 2000, [6] = 30000}, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0},
        ...
        ['Elemental Synthesis'] = { id = 299, name = 'Elemental Synthesis', words = 'utito dru', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 189, group = { [3] = 2000, [7] = 30000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {2, 6}, special = false, source = 0 },
        ['Shared Conservation'] = { id = 300, name = 'Shared Conservation', words = 'utura sio', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 190, group = { [3] = 2000, [7] = 30000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {2, 6}, special = false, source = 0 },
        ['Master of Flames'] = { id = 301, name = 'Master of Flames', words = 'uteta flam', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 191, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0 },
        ['Master of Thunder'] = { id = 302, name = 'Master of Thunder', words = 'uteta vis', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 192, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0 },
        ['Master of Decay'] = { id = 303, name = 'Master of Decay', words = 'uteta mort', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 193, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {1, 5}, special = false, source = 0 },
        ['Divine Defiance'] = { id = 304, name = 'Divine Defiance', words = 'utori hur', type = 'Instant', level = 20, mana = 250, soul = 0, maglevel = 0, icon = '', clientId = 194, group = { [3] = 2000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {3, 7}, special = false, source = 0, description = 'Distance power contributes to Holy and Healing Magic; dodge chance is increased.' },
        ['Forked Thorns'] = { id = 298, name = 'Forked Thorns', words = 'exevo fur tera', type = 'Instant', level = 80, mana = 180, soul = 0, maglevel = 0, icon = '', clientId = 187, group = { [1] = 2000 }, needTarget = true, parameter = false, range = 3, exhaustion = 6000, premium = true, vocations = {2, 6}, special = false, source = 0 },
        ['Forked Glacier'] = { id = 305, name = 'Forked Glacier', words = 'exevo fur frigo', type = 'Instant', level = 90, mana = 180, soul = 0, maglevel = 0, icon = '', clientId = 188, group = { [1] = 2000 }, needTarget = true, parameter = false, range = 3, exhaustion = 6000, premium = true, vocations = {2, 6}, special = false, source = 0 },
    }
}
