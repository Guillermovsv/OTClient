...
SpellInfo = {
    Default = {
        ...
        ['Elemental Synthesis'] = { id = 299, name = 'Elemental Synthesis', words = 'utito dru', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 31, group = { [3] = 2000, [7] = 30000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {2, 6}, special = false, source = 0 },
        ['Shared Conservation'] = { id = 300, name = 'Shared Conservation', words = 'utura sio', type = 'Instant', level = 20, mana = 400, soul = 0, maglevel = 0, icon = '', clientId = 125, group = { [3] = 2000, [7] = 30000 }, needTarget = false, parameter = false, range = -1, exhaustion = 30000, premium = true, vocations = {2, 6}, special = false, source = 0 },
